...
import { AUTHOR_NAME, AUTHOR_GITHUB_PROFILE } from "../../constants/siteInfo.constants";
...
export const SiteFooterContainer = (): SiteFooterContainerReturns => (
  <SiteFooter authorName={AUTHOR_NAME} authorGithubProfileLink={AUTHOR_GITHUB_PROFILE} />
);
